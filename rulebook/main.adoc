...
PEPPOL Participant:: An organization using the PEPPOL eDelivery network for exchange of PEPPOL Business Documents
...
* New versions of specifications and components will be developed in an open and transparent manner in consultation with Bits and the involved stakeholders;
...
These basic requirements has been further elaborated in link:#ref-12[[12\]] which defines the minimum security requirements for data transport in the financial industry. This specification defines requirements related to key security aspects such as:
...
IMPORTANT: A PEPPOL AP Provider offering services for transport of ISO 20022-based financial messages in the Enhanced PEPPOL eDelivery network shall have a PEPPOL eDelivery Agreement and a PEPPOL Payment Agreement signed with the appropriate PEPPOL Authority.
